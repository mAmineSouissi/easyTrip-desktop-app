...
public class Hotel {
    ...
    public Hotel(int id, String name, String adresse, String city, int rating, String description, float price,
                 String typeRoom, int numRoom, String image, Promotion promotion, Agence agence, int promotionID) {
        this.id = id;
        this.name = name;
    ...
    // Getters et setters (supprimez ceux pour userId)
