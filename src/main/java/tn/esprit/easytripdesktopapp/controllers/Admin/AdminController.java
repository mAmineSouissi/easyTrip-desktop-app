...
public class AdminController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            for (cars car : carsList) {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/easytripdesktopapp/FXML/Admin/AdminCarCard.fxml"));
    ...
    void GoToAddCar(MouseEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/easytripdesktopapp/FXML/Admin/AddCar.fxml"));
